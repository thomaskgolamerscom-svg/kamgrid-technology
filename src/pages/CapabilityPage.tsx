        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-white rounded-2xl p-8 sm:p-12 border border-slate-200 shadow-sm grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="p-4 bg-slate-50 rounded-lg border-l-4 border-amber-500 text-xs sm:text-sm font-semibold text-[#0B1E3D]">
                <span>Engineering teams mobilized across Aba, Umuahia, Enugu, Port Harcourt and nationwide locations.</span>
              </div>
            </div>
            ...
            <div className="lg:col-span-5">
              <div className="rounded-xl overflow-hidden border border-slate-300 shadow-md">
                <ImageWithFallback
                  src={KAMGRID_IMAGES.capability.commercialInfrastructure}
                  alt="KAMGRID Commercial infrastructure engineering facility and solar array"
                ...
                <div className="bg-slate-900 px-3.5 py-2 text-[11px] font-mono text-slate-300 flex items-center justify-between border-t border-slate-800">
                  <span>COMMERCIAL DEPLOYMENT CAPACITY</span>
                  <span className="text-amber-400">ENGINEERING SPEC</span>
                </div>
              </div>
            </div>
          </div>
